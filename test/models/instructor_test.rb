...
class InstructorTest < ActiveSupport::TestCase
  def setup
    @instructor = Instructor.new(name: "Example Instructor", email: "instructor@example.com",
  ...
  test "email validation should accept valid addresses" do
    ...
    valid_addresses.each do |valid_address|
      ...
      assert @instructor.valid?, "#{valid_address.inspect} should be valid"
    end
  end
  ...
  test "email validation should reject invalid addresses" do
    ...
    invalid_addresses.each do |invalid_address|
      ...
      assert_not @instructor.valid?, "#{invalid_address.inspect} should be invalid"
    end
  end
